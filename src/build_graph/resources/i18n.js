...
const I18N = {
    en: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Toggle git-activity heat overlay",
        "btn.heatNotAvailable": "Not in a git repository",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Toggle test-coverage overlay",
        "btn.faqTitle": "Help (?)",
        ...
        "legend.heat": "Activity heat",
        "legend.coverage": "Test coverage",
        "legend.coverageMaxTitle": "Hide files covered more than N%",
        "legend.heatMinTitle": "Hide files edited fewer than N times",
        ...
        "faq.section.heatMode": "Heat mode",
        "faq.section.coverage": "Test coverage mode",
        ...
        "faq.filters.li13": "<b>Node tooltip</b>: hover any node to see its name and path; in Heat or Coverage mode it also shows the number of edits or the coverage percentage behind the color. Edge tooltips are suppressed in those two modes &mdash; they aren't relevant there.",
        ...
        "faq.git.li6": "<b>Graph diff:</b> a build with <code>--diff-base REF</code> compares the working tree against a git ref &mdash; file statuses feed this overlay, while new dependency edges turn green and removed ones red (dashed).",
        "faq.heat.li1": "Toggle <b>Heat mode</b> from the top bar &mdash; node colors switch from type-based to a blue&rarr;red gradient by how often each file has changed in git.",
        "faq.heat.li2": "The gradient legend shows the period (whole history, or the last N days if the build ran with <code>--heat-days N</code>) and the raw commit-count range.",
        "faq.heat.li3": "Heat and Git mode are mutually exclusive &mdash; turning one on turns the other off, since both recolor nodes by a different signal.",
        "faq.coverage.li1": "Toggle <b>Coverage mode</b> from the top bar &mdash; node colors switch from type-based to a green&rarr;red gradient by test-line coverage (needs a Cobertura <code>coverage.xml</code>, via <code>--coverage PATH</code>).",
        "faq.coverage.li2": "The gradient legend shows the coverage range and a max-coverage slider &mdash; drag it down to hide anything covered more than the chosen ceiling, isolating the worst-covered files (edges follow).",
        "faq.coverage.li3": "Coverage, Heat and Git mode are all mutually exclusive &mdash; turning one on turns the other two off, since all three recolor nodes by a different signal.",
        "faq.coverage.li4": "Turning Coverage mode on automatically hides every Node type except code &mdash; those are the only files a coverage report can ever say anything about. Any category can still be shown again from the legend, same as hiding any other type.",
        "legend.diffEdgesAdded": "New edges",
        "legend.diffEdgesRemoved": "Removed edges",
        ...
        "btn.cycles": "Cycles",
        "btn.cyclesTitle": "Highlight circular imports — files that import each other in a loop",
        "faq.filters.li12": "<b>Cycles</b> button (in the legend, only when import loops exist) highlights circular <code>import</code> chains between code files in coral. Imports made only under <code>TYPE_CHECKING</code> don't count &mdash; they exist precisely to break such loops.",
    ...
    ru: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Подсветка по частоте изменений (git)",
        "btn.heatNotAvailable": "Не git-репозиторий",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Подсветка по покрытию тестами",
        ...
        "legend.heat": "Частота изменений",
        "legend.coverage": "Покрытие тестами",
        "legend.coverageMaxTitle": "Скрывать файлы с покрытием больше N%",
        "legend.heatMinTitle": "Скрывать файлы, изменённые реже N раз",
        ...
        "faq.section.heatMode": "Режим активности",
        "faq.section.coverage": "Режим покрытия тестами",
        ...
        "faq.filters.li13": "<b>Подсказка по ноде</b>: наведите на ноду, чтобы увидеть её имя и путь; в режимах Heatmap и Coverage там же показывается число правок или процент покрытия, стоящие за цветом. В этих двух режимах подсказки по рёбрам отключены &mdash; они не нужны.",
        ...
        "faq.git.li6": "<b>Дифф графа:</b> сборка с <code>--diff-base REF</code> сравнивает рабочее дерево с git-ссылкой &mdash; статусы файлов попадают в этот оверлей, новые связи подсвечиваются зелёным, удалённые &mdash; красным (пунктир).",
        "faq.heat.li1": "Переключатель <b>режима активности</b> в верхней панели &mdash; цвета узлов меняются с типов на градиент синий&rarr;красный по тому, как часто файл менялся в git.",
        "faq.heat.li2": "Градиентная легенда показывает период (вся история, либо последние N дней, если сборка запущена с <code>--heat-days N</code>) и диапазон количества коммитов.",
        "faq.heat.li3": "Режимы активности и Git взаимоисключающие &mdash; включение одного выключает другой, оба красят узлы по разным сигналам.",
        "faq.coverage.li1": "Переключатель <b>режима покрытия</b> в верхней панели &mdash; цвета узлов меняются с типов на градиент зелёный&rarr;красный по покрытию тестами (нужен Cobertura <code>coverage.xml</code>, через <code>--coverage PATH</code>).",
        "faq.coverage.li2": "Градиентная легенда показывает диапазон покрытия и слайдер-потолок покрытия &mdash; тяните вниз, чтобы скрыть файлы с покрытием больше выбранного порога, оставив самые непокрытые (рёбра гаснут сами).",
        "faq.coverage.li3": "Режимы покрытия, активности и Git взаимоисключающие &mdash; включение одного выключает два других, все три красят узлы по разным сигналам.",
        "faq.coverage.li4": "Включение режима покрытия автоматически скрывает все Node types кроме code &mdash; только по этим файлам отчёт покрытия вообще может что-то сказать. Любую категорию можно снова показать из легенды, как и при скрытии любого другого типа.",
        "legend.diffEdgesAdded": "Новые связи",
        "legend.diffEdgesRemoved": "Удалённые связи",
        ...
        "btn.cycles": "Циклы",
        "btn.cyclesTitle": "Подсветить циклические импорты — файлы, импортирующие друг друга по кругу",
        "faq.filters.li12": "Кнопка <b>Циклы</b> (в легенде, появляется только при наличии импорт-петель) подсвечивает коралловым цепочки взаимных <code>import</code> между файлами кода. Импорты только под <code>TYPE_CHECKING</code> не учитываются &mdash; они как раз разрывают такие петли.",
    ...
    de: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Aktivitäts-Overlay (git) umschalten",
        "btn.heatNotAvailable": "Kein Git-Repository",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Testabdeckungs-Overlay umschalten",
        "btn.faqTitle": "Hilfe (?)",
        ...
        "legend.gitStatus": "Git-Status",
        "legend.heat": "Änderungsaktivität",
        "legend.coverage": "Testabdeckung",
        "legend.coverageMaxTitle": "Dateien ausblenden, die zu mehr als N% abgedeckt sind",
        "legend.heatMinTitle": "Dateien ausblenden, die seltener als N Mal geändert wurden",
        ...
        "faq.section.heatMode": "Aktivitätsmodus",
        "faq.section.coverage": "Testabdeckungsmodus",
        ...
        "faq.filters.li13": "<b>Knoten-Tooltip</b>: beim Überfahren eines Knotens werden Name und Pfad angezeigt; im Heatmap- oder Abdeckungsmodus zusätzlich die Anzahl der Änderungen bzw. der Abdeckungsprozentsatz hinter der Farbe. Kanten-Tooltips sind in diesen beiden Modi deaktiviert &mdash; dort nicht relevant.",
        ...
        "faq.git.li6": "<b>Graph-Diff:</b> ein Build mit <code>--diff-base REF</code> vergleicht den Arbeitsbaum mit einer Git-Referenz &mdash; Dateistatus speist dieses Overlay, neue Abhängigkeitskanten werden grün, entfernte rot (gestrichelt).",
        "faq.heat.li1": "Mit <b>Aktivitätsmodus</b> in der oberen Leiste umschalten &mdash; Knotenfarben wechseln von Typ-basiert zu einem Blau&rarr;Rot-Verlauf nach Änderungshäufigkeit in git.",
        "faq.heat.li2": "Die Verlaufslegende zeigt den Zeitraum (gesamte Historie oder die letzten N Tage bei <code>--heat-days N</code>) und die Spannweite der Commit-Anzahl.",
        "faq.heat.li3": "Aktivitäts- und Git-Modus schließen sich gegenseitig aus &mdash; das Einschalten des einen schaltet den anderen aus, da beide Knoten nach unterschiedlichen Signalen einfärben.",
        "faq.coverage.li1": "Mit <b>Abdeckungsmodus</b> in der oberen Leiste umschalten &mdash; Knotenfarben wechseln von Typ-basiert zu einem Grün&rarr;Rot-Verlauf nach Testabdeckung (benötigt eine Cobertura-<code>coverage.xml</code> via <code>--coverage PATH</code>).",
        "faq.coverage.li2": "Die Verlaufslegende zeigt den Abdeckungsbereich und einen Höchstabdeckungs-Regler &mdash; nach unten ziehen, um alles oberhalb der gewählten Obergrenze auszublenden und so die am schlechtesten abgedeckten Dateien zu isolieren (Kanten folgen).",
        "faq.coverage.li3": "Abdeckungs-, Aktivitäts- und Git-Modus schließen sich alle gegenseitig aus &mdash; das Einschalten eines Modus schaltet die anderen beiden aus, da alle drei Knoten nach unterschiedlichen Signalen einfärben.",
        "faq.coverage.li4": "Das Einschalten des Abdeckungsmodus blendet automatisch alle Node types außer code aus &mdash; nur zu diesen Dateien kann ein Abdeckungsbericht überhaupt etwas aussagen. Jede Kategorie lässt sich über die Legende wieder einblenden, genau wie beim Ausblenden jedes anderen Typs.",
        "legend.diffEdgesAdded": "Neue Kanten",
        "legend.diffEdgesRemoved": "Entfernte Kanten",
        ...
        "btn.cycles": "Zyklen",
        "btn.cyclesTitle": "Zirkuläre Importe hervorheben — Dateien, die sich gegenseitig im Kreis importieren",
        "faq.filters.li12": "Schaltfläche <b>Zyklen</b> (in der Legende, nur bei vorhandenen Import-Schleifen) hebt zirkuläre <code>import</code>-Ketten zwischen Code-Dateien korallenrot hervor. Importe nur unter <code>TYPE_CHECKING</code> zählen nicht &mdash; sie existieren gerade, um solche Schleifen zu durchbrechen.",
    ...
    es: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Activar superposición de actividad (git)",
        "btn.heatNotAvailable": "No es un repositorio git",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Activar superposición de cobertura de pruebas",
        "btn.faqTitle": "Ayuda (?)",
        ...
        "legend.heat": "Actividad de cambios",
        "legend.coverage": "Cobertura de pruebas",
        "legend.coverageMaxTitle": "Ocultar archivos con más de N% de cobertura",
        "legend.heatMinTitle": "Ocultar archivos editados menos de N veces",
        ...
        "heat.allTime": "Todo el historial",
        ...
        "faq.section.heatMode": "Modo de actividad",
        "faq.section.coverage": "Modo de cobertura de pruebas",
        ...
        "faq.filters.li13": "<b>Información del nodo</b>: pasa el cursor sobre un nodo para ver su nombre y ruta; en el modo Heatmap o Cobertura también muestra el número de ediciones o el porcentaje de cobertura detrás del color. Los tooltips de aristas se desactivan en esos dos modos &mdash; no son relevantes ahí.",
        ...
        "faq.git.li6": "<b>Diff del grafo:</b> una compilación con <code>--diff-base REF</code> compara el árbol de trabajo con una referencia git &mdash; los estados de archivo alimentan esta capa, las aristas nuevas se muestran en verde y las eliminadas en rojo (discontinuo).",
        "faq.heat.li1": "Activa el <b>modo de actividad</b> desde la barra superior &mdash; los colores de los nodos cambian de tipo a un degradado azul&rarr;rojo según la frecuencia de cambios en git.",
        "faq.heat.li2": "La leyenda de degradado muestra el período (todo el historial, o los últimos N días con <code>--heat-days N</code>) y el rango de número de commits.",
        "faq.heat.li3": "Los modos de actividad y git son mutuamente excluyentes &mdash; activar uno desactiva el otro, ya que ambos colorean los nodos según una señal distinta.",
        "faq.coverage.li1": "Activa el <b>modo de cobertura</b> desde la barra superior &mdash; los colores de los nodos cambian de tipo a un degradado verde&rarr;rojo según la cobertura de pruebas (necesita un <code>coverage.xml</code> Cobertura vía <code>--coverage PATH</code>).",
        "faq.coverage.li2": "La leyenda de degradado muestra el rango de cobertura y un control deslizante de techo de cobertura &mdash; arrástralo hacia abajo para ocultar lo que supere el porcentaje elegido, aislando los archivos peor cubiertos (las aristas le siguen).",
        "faq.coverage.li3": "Los modos de cobertura, actividad y git son mutuamente excluyentes &mdash; activar uno desactiva los otros dos, ya que los tres colorean los nodos según una señal distinta.",
        "faq.coverage.li4": "Activar el modo de cobertura oculta automáticamente todos los Node types excepto code &mdash; son los únicos archivos sobre los que un informe de cobertura puede decir algo. Cualquier categoría puede volver a mostrarse desde la leyenda, igual que al ocultar cualquier otro tipo.",
        "legend.diffEdgesAdded": "Aristas nuevas",
        "legend.diffEdgesRemoved": "Aristas eliminadas",
        ...
        "btn.cycles": "Ciclos",
        "btn.cyclesTitle": "Resaltar importaciones circulares — archivos que se importan mutuamente en bucle",
        "faq.filters.li12": "El botón <b>Ciclos</b> (en la leyenda, solo cuando existen bucles de importación) resalta en coral las cadenas circulares de <code>import</code> entre archivos de código. Las importaciones solo bajo <code>TYPE_CHECKING</code> no cuentan &mdash; existen precisamente para romper esos bucles.",
    ...
    it: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Attiva sovrapposizione attività (git)",
        "btn.heatNotAvailable": "Non è un repository git",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Attiva sovrapposizione di copertura dei test",
        "btn.faqTitle": "Aiuto (?)",
        ...
        "legend.heat": "Attività di modifica",
        "legend.coverage": "Copertura dei test",
        "legend.coverageMaxTitle": "Nascondi i file con copertura superiore a N%",
        "legend.heatMinTitle": "Nascondi i file modificati meno di N volte",
        ...
        "git.clean": "Invariato",
        "heat.allTime": "Intera cronologia",
        ...
        "faq.section.heatMode": "Modalità attività",
        "faq.section.coverage": "Modalità copertura test",
        ...
        "faq.filters.li13": "<b>Tooltip del nodo</b>: passa il mouse su un nodo per vederne nome e percorso; in modalità Heatmap o Copertura mostra anche il numero di modifiche o la percentuale di copertura dietro il colore. I tooltip degli archi sono disattivati in queste due modalità &mdash; non sono rilevanti lì.",
        ...
        "faq.git.li6": "<b>Diff del grafo:</b> una build con <code>--diff-base REF</code> confronta l'albero di lavoro con un riferimento git &mdash; gli stati dei file alimentano questo overlay, gli archi nuovi diventano verdi e quelli rimossi rossi (tratteggiati).",
        "faq.heat.li1": "Attiva la <b>modalità attività</b> dalla barra superiore &mdash; i colori dei nodi passano da basati sul tipo a un gradiente blu&rarr;rosso in base alla frequenza di modifica in git.",
        "faq.heat.li2": "La legenda del gradiente mostra il periodo (intera cronologia, oppure gli ultimi N giorni con <code>--heat-days N</code>) e l'intervallo del numero di commit.",
        "faq.heat.li3": "Le modalità attività e git si escludono a vicenda &mdash; attivarne una disattiva l'altra, perché entrambe colorano i nodi in base a un segnale diverso.",
        "faq.coverage.li1": "Attiva la <b>modalità copertura</b> dalla barra superiore &mdash; i colori dei nodi passano da basati sul tipo a un gradiente verde&rarr;rosso in base alla copertura dei test (richiede un <code>coverage.xml</code> Cobertura tramite <code>--coverage PATH</code>).",
        "faq.coverage.li2": "La legenda del gradiente mostra l'intervallo di copertura e uno slider di soglia massima &mdash; trascinalo verso il basso per nascondere ciò che supera la percentuale scelta, isolando i file peggio coperti (gli archi seguono).",
        "faq.coverage.li3": "Le modalità copertura, attività e git si escludono tutte a vicenda &mdash; attivarne una disattiva le altre due, perché tutte e tre colorano i nodi in base a un segnale diverso.",
        "faq.coverage.li4": "Attivando la modalità copertura si nascondono automaticamente tutti i Node types tranne code &mdash; sono gli unici file su cui un report di copertura può dire qualcosa. Qualsiasi categoria può essere mostrata di nuovo dalla legenda, come per nascondere qualsiasi altro tipo.",
        "legend.diffEdgesAdded": "Archi nuovi",
        "legend.diffEdgesRemoved": "Archi rimossi",
        ...
        "btn.cycles": "Cicli",
        "btn.cyclesTitle": "Evidenzia le importazioni circolari — file che si importano a vicenda in un ciclo",
        "faq.filters.li12": "Il pulsante <b>Cicli</b> (nella legenda, solo quando esistono cicli di importazione) evidenzia in corallo le catene circolari di <code>import</code> tra file di codice. Le importazioni solo sotto <code>TYPE_CHECKING</code> non contano &mdash; esistono proprio per spezzare questi cicli.",
    ...
    fr: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Activer la superposition d'activité (git)",
        "btn.heatNotAvailable": "Pas un dépôt git",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Activer la superposition de couverture de tests",
        "btn.faqTitle": "Aide (?)",
        ...
        "legend.heat": "Activité de modification",
        "legend.coverage": "Couverture de tests",
        "legend.coverageMaxTitle": "Masquer les fichiers couverts à plus de N%",
        "legend.heatMinTitle": "Masquer les fichiers modifiés moins de N fois",
        ...
        "git.clean": "Inchangé",
        "heat.allTime": "Tout l'historique",
        ...
        "faq.section.heatMode": "Mode activité",
        "faq.section.coverage": "Mode de couverture de tests",
        ...
        "faq.filters.li13": "<b>Infobulle du nœud</b> : survolez un nœud pour voir son nom et son chemin ; en mode Heatmap ou Couverture, elle affiche aussi le nombre de modifications ou le pourcentage de couverture derrière la couleur. Les infobulles des liens sont désactivées dans ces deux modes &mdash; elles n'y sont pas pertinentes.",
        ...
        "faq.git.li6": "<b>Diff du graphe&nbsp;:</b> une génération avec <code>--diff-base REF</code> compare l'arbre de travail à une référence git &mdash; les états de fichiers alimentent cette surcouche, les liens nouveaux passent en vert et les liens supprimés en rouge (pointillés).",
        "faq.heat.li1": "Active le <b>mode activité</b> depuis la barre supérieure &mdash; les couleurs des nœuds passent d'un code par type à un dégradé bleu&rarr;rouge selon la fréquence de modification dans git.",
        "faq.heat.li2": "La légende du dégradé affiche la période (tout l'historique, ou les N derniers jours avec <code>--heat-days N</code>) et la plage du nombre de commits.",
        "faq.heat.li3": "Les modes activité et git s'excluent mutuellement &mdash; activer l'un désactive l'autre, car les deux colorent les nœuds selon un signal différent.",
        "faq.coverage.li1": "Active le <b>mode couverture</b> depuis la barre supérieure &mdash; les couleurs des nœuds passent d'un code par type à un dégradé vert&rarr;rouge selon la couverture de tests (nécessite un <code>coverage.xml</code> Cobertura via <code>--coverage PATH</code>).",
        "faq.coverage.li2": "La légende du dégradé affiche la plage de couverture et un curseur de plafond de couverture &mdash; faites-le glisser vers le bas pour masquer tout ce qui dépasse le pourcentage choisi, isolant les fichiers les moins couverts (les liens suivent).",
        "faq.coverage.li3": "Les modes couverture, activité et git s'excluent tous mutuellement &mdash; activer l'un désactive les deux autres, car les trois colorent les nœuds selon un signal différent.",
        "faq.coverage.li4": "Activer le mode couverture masque automatiquement tous les Node types sauf code &mdash; ce sont les seuls fichiers sur lesquels un rapport de couverture peut dire quoi que ce soit. Chaque catégorie peut être réaffichée depuis la légende, comme pour masquer n'importe quel autre type.",
        "legend.diffEdgesAdded": "Liens nouveaux",
        "legend.diffEdgesRemoved": "Liens supprimés",
        ...
        "btn.cycles": "Cycles",
        "btn.cyclesTitle": "Mettre en évidence les importations circulaires — des fichiers qui s'importent mutuellement en boucle",
        "faq.filters.li12": "Le bouton <b>Cycles</b> (dans la légende, uniquement en présence de boucles d'importation) met en évidence en corail les chaînes circulaires d'<code>import</code> entre fichiers de code. Les importations uniquement sous <code>TYPE_CHECKING</code> ne comptent pas &mdash; elles existent précisément pour briser ces boucles.",
    ...
    pt: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "Ativar sobreposição de atividade (git)",
        "btn.heatNotAvailable": "Não é um repositório git",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "Ativar sobreposição de cobertura de testes",
        "btn.faqTitle": "Ajuda (?)",
        ...
        "legend.heat": "Atividade de alterações",
        "legend.coverage": "Cobertura de testes",
        "legend.coverageMaxTitle": "Ocultar arquivos com cobertura maior que N%",
        "legend.heatMinTitle": "Ocultar arquivos editados menos de N vezes",
        ...
        "faq.section.gitMode": "Modo git",
        "faq.section.heatMode": "Modo de atividade",
        "faq.section.coverage": "Modo de cobertura de testes",
        ...
        "faq.filters.li13": "<b>Dica do nó</b>: passe o mouse sobre um nó para ver seu nome e caminho; no modo Heatmap ou Cobertura também mostra o número de edições ou a porcentagem de cobertura por trás da cor. As dicas de arestas são desativadas nesses dois modos &mdash; não são relevantes ali.",
        ...
        "faq.git.li6": "<b>Diff do grafo:</b> uma build com <code>--diff-base REF</code> compara a árvore de trabalho com uma referência git &mdash; os status de arquivo alimentam esta camada, arestas novas ficam verdes e as removidas vermelhas (tracejadas).",
        "faq.heat.li1": "Ative o <b>modo atividade</b> na barra superior &mdash; as cores dos nós mudam de baseadas em tipo para um gradiente azul&rarr;vermelho conforme a frequência de alterações no git.",
        "faq.heat.li2": "A legenda do gradiente mostra o período (todo o histórico, ou os últimos N dias com <code>--heat-days N</code>) e o intervalo do número de commits.",
        "faq.heat.li3": "Os modos atividade e git são mutuamente exclusivos &mdash; ativar um desativa o outro, já que ambos colorem os nós por um sinal diferente.",
        "faq.coverage.li1": "Ative o <b>modo cobertura</b> na barra superior &mdash; as cores dos nós mudam de baseadas em tipo para um gradiente verde&rarr;vermelho conforme a cobertura de testes (requer um <code>coverage.xml</code> Cobertura via <code>--coverage PATH</code>).",
        "faq.coverage.li2": "A legenda do gradiente mostra o intervalo de cobertura e um controle deslizante de teto de cobertura &mdash; arraste para baixo para ocultar o que exceder a porcentagem escolhida, isolando os arquivos com pior cobertura (as arestas seguem).",
        "faq.coverage.li3": "Os modos cobertura, atividade e git são todos mutuamente exclusivos &mdash; ativar um desativa os outros dois, já que os três colorem os nós por um sinal diferente.",
        "faq.coverage.li4": "Ativar o modo cobertura oculta automaticamente todos os Node types exceto code &mdash; são os únicos arquivos sobre os quais um relatório de cobertura pode dizer algo. Qualquer categoria pode ser exibida novamente pela legenda, assim como ao ocultar qualquer outro tipo.",
        "legend.diffEdgesAdded": "Arestas novas",
        "legend.diffEdgesRemoved": "Arestas removidas",
        ...
        "btn.cycles": "Ciclos",
        "btn.cyclesTitle": "Destacar importações circulares — arquivos que se importam mutuamente em loop",
        "faq.filters.li12": "O botão <b>Ciclos</b> (na legenda, apenas quando existem loops de importação) destaca em coral as cadeias circulares de <code>import</code> entre arquivos de código. Importações apenas sob <code>TYPE_CHECKING</code> não contam &mdash; elas existem justamente para quebrar esses loops.",
    ...
    zh: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "切换 git 活跃度热力叠加",
        "btn.heatNotAvailable": "不是 git 仓库",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "切换测试覆盖率叠加",
        "btn.faqTitle": "帮助 (?)",
        ...
        "legend.heat": "变更活跃度",
        "legend.coverage": "测试覆盖率",
        "legend.coverageMaxTitle": "隐藏覆盖率高于 N% 的文件",
        "legend.heatMinTitle": "隐藏改动次数少于 N 次的文件",
        "legend.showAll": "全部显示",
        "legend.hideAll": "全部隐藏",
        "git.added": "新增",
        "git.modified": "已修改",
        ...
        "faq.section.heatMode": "活跃度模式",
        "faq.section.coverage": "测试覆盖率模式",
        ...
        "faq.filters.li13": "<b>节点提示</b>：将鼠标悬停在节点上可查看其名称和路径；在 Heatmap 或 Coverage 模式下还会显示颜色背后的修改次数或覆盖率百分比。这两种模式下边的提示已禁用&mdash;在那里没有意义。",
        ...
        "faq.git.li6": "<b>图差异：</b>使用 <code>--diff-base REF</code> 构建会将工作区与 git 引用进行比较——文件状态进入此覆盖层，新增的依赖边显示为绿色，移除的边显示为红色（虚线）。",
        "faq.heat.li1": "在顶部栏切换<b>活跃度模式</b> &mdash; 节点颜色从按类型着色变为按 git 中文件变更频率的蓝&rarr;红渐变。",
        "faq.heat.li2": "渐变图例显示时间范围(全部历史,或使用 <code>--heat-days N</code> 构建时的最近 N 天)以及提交次数的范围。",
        "faq.heat.li3": "活跃度模式与 Git 模式互斥 &mdash; 开启一个会关闭另一个,因为二者按不同信号为节点着色。",
        "faq.coverage.li1": "在顶部栏切换<b>覆盖率模式</b> &mdash; 节点颜色从按类型着色变为按测试覆盖率的绿&rarr;红渐变(需要通过 <code>--coverage PATH</code> 提供 Cobertura <code>coverage.xml</code>)。",
        "faq.coverage.li2": "渐变图例显示覆盖率范围和覆盖率上限滑块 &mdash; 向下拖动以隐藏覆盖率高于所选阈值的文件,从而只留下覆盖最差的文件(边会一同隐藏)。",
        "faq.coverage.li3": "覆盖率、活跃度和 Git 模式互斥 &mdash; 开启一个会关闭另外两个,因为三者按不同信号为节点着色。",
        "faq.coverage.li4": "开启覆盖率模式会自动隐藏除 code 以外的所有 Node types &mdash; 覆盖率报告只能反映这些文件的信息。仍可从图例中重新显示任意分类，与隐藏其他类型的方式相同。",
        "legend.diffEdgesAdded": "新增边",
        "legend.diffEdgesRemoved": "移除的边",
        ...
        "btn.cycles": "循环",
        "btn.cyclesTitle": "高亮循环导入——在环路中相互导入的文件",
        "faq.filters.li12": "<b>循环</b>按钮（位于图例中，仅在存在导入环路时显示）以珊瑚色高亮代码文件之间的循环 <code>import</code> 链。仅在 <code>TYPE_CHECKING</code> 下的导入不计入 &mdash; 它们正是为打破这类环路而存在的。",
    ...
    ja: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "git 活動ヒートオーバーレイを切り替え",
        "btn.heatNotAvailable": "Git リポジトリではありません",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "テストカバレッジのオーバーレイを切り替え",
        "btn.faqTitle": "ヘルプ (?)",
        ...
        "legend.heat": "変更アクティビティ",
        "legend.coverage": "テストカバレッジ",
        "legend.coverageMaxTitle": "カバレッジが N% を超えるファイルを非表示",
        "legend.heatMinTitle": "N 回未満しか変更されていないファイルを非表示",
        ...
        "faq.section.heatMode": "アクティビティモード",
        "faq.section.coverage": "テストカバレッジモード",
        ...
        "faq.filters.li13": "<b>ノードツールチップ</b>：ノードにカーソルを合わせると名前とパスが表示されます。Heatmap モードまたは Coverage モードでは、色の背後にある変更回数やカバレッジ率も表示されます。この2つのモードではエッジのツールチップは無効化されています&mdash;そこでは意味がないためです。",
        ...
        "faq.git.li6": "<b>グラフ差分:</b> <code>--diff-base REF</code> でビルドすると、作業ツリーを Git 参照と比較します。ファイルの状態はこのオーバーレイに反映され、新しい依存エッジは緑、削除されたエッジは赤（破線）で表示されます。",
        "faq.heat.li1": "上部バーで<b>アクティビティモード</b>を切り替え &mdash; ノードの色がタイプ別から、git での変更頻度に応じた青&rarr;赤のグラデーションに変わります。",
        "faq.heat.li2": "グラデーション凡例には期間(全期間、または <code>--heat-days N</code> でビルドした場合は直近 N 日間)とコミット数の範囲が表示されます。",
        "faq.heat.li3": "アクティビティモードと Git モードは排他的です &mdash; 一方をオンにすると他方はオフになります。両者は異なる信号でノードを着色するためです。",
        "faq.coverage.li1": "上部バーで<b>カバレッジモード</b>を切り替え &mdash; ノードの色がタイプ別から、テストカバレッジに応じた緑&rarr;赤のグラデーションに変わります(<code>--coverage PATH</code> で Cobertura の <code>coverage.xml</code> が必要です)。",
        "faq.coverage.li2": "グラデーション凡例にはカバレッジ範囲と上限カバレッジスライダーが表示されます &mdash; 下にドラッグすると選択した割合を超えるファイルが非表示になり、カバレッジが最も低いファイルだけが残ります(エッジも連動します)。",
        "faq.coverage.li3": "カバレッジモード、アクティビティモード、Git モードはすべて排他的です &mdash; 一つをオンにすると他の二つはオフになります。三つとも異なる信号でノードを着色するためです。",
        "faq.coverage.li4": "カバレッジモードをオンにすると、code 以外のすべての Node types が自動的に非表示になります &mdash; カバレッジレポートが何かを示せるのはこれらのファイルだけだからです。他のタイプを非表示にする場合と同様、凡例から任意のカテゴリを再表示できます。",
        "legend.diffEdgesAdded": "新しいエッジ",
        "legend.diffEdgesRemoved": "削除されたエッジ",
        ...
        "btn.cycles": "循環",
        "btn.cyclesTitle": "循環インポートをハイライト — ループ状に相互インポートしているファイル",
        "faq.filters.li12": "<b>循環</b>ボタン（凡例内、インポートループが存在する場合のみ表示）は、コードファイル間の循環 <code>import</code> チェーンをコーラル色でハイライトします。<code>TYPE_CHECKING</code> 下のみのインポートはカウントされません &mdash; それはまさにこうしたループを断ち切るためのものだからです。",
    ...
    ko: {
        ...
        "btn.heat": "Heatmap",
        "btn.heatTitle": "git 활동 히트 오버레이 전환",
        "btn.heatNotAvailable": "Git 저장소가 아닙니다",
        "btn.coverage": "Cov.",
        "btn.coverageTitle": "테스트 커버리지 오버레이 전환",
        "btn.faqTitle": "도움말 (?)",
        ...
        "legend.heat": "변경 활동량",
        "legend.coverage": "테스트 커버리지",
        "legend.coverageMaxTitle": "커버리지가 N%를 초과하는 파일 숨기기",
        "legend.heatMinTitle": "N회 미만으로 변경된 파일 숨기기",
        ...
        "faq.section.heatMode": "활동량 모드",
        "faq.section.coverage": "테스트 커버리지 모드",
        ...
        "faq.filters.li13": "<b>노드 툴팁</b>: 노드에 마우스를 올리면 이름과 경로가 표시됩니다. Heatmap 또는 Coverage 모드에서는 색상 뒤에 있는 수정 횟수나 커버리지 비율도 함께 표시됩니다. 이 두 모드에서는 엣지 툴팁이 비활성화됩니다&mdash;거기서는 의미가 없기 때문입니다.",
        ...
        "faq.git.li6": "<b>그래프 diff:</b> <code>--diff-base REF</code>로 빌드하면 작업 트리를 git 참조와 비교합니다. 파일 상태는 이 오버레이에 반영되고, 새 의존성 엣지는 녹색, 제거된 엣지는 빨간색(점선)으로 표시됩니다.",
        "faq.heat.li1": "상단 바에서 <b>활동량 모드</b>를 전환하세요 &mdash; 노드 색상이 유형 기반에서 git 변경 빈도에 따른 파랑&rarr;빨강 그라데이션으로 바뀝니다.",
        "faq.heat.li2": "그라데이션 범례에는 기간(전체 기록, 또는 <code>--heat-days N</code>으로 빌드한 경우 최근 N일)과 커밋 횟수 범위가 표시됩니다.",
        "faq.heat.li3": "활동량 모드와 Git 모드는 상호 배타적입니다 &mdash; 하나를 켜면 다른 하나는 꺼집니다. 두 모드는 서로 다른 신호로 노드를 색칠하기 때문입니다.",
        "faq.coverage.li1": "상단 바에서 <b>커버리지 모드</b>를 전환하세요 &mdash; 노드 색상이 유형 기반에서 테스트 커버리지에 따른 초록&rarr;빨강 그라데이션으로 바뀝니다(<code>--coverage PATH</code>로 Cobertura <code>coverage.xml</code>이 필요합니다).",
        "faq.coverage.li2": "그라데이션 범례에는 커버리지 범위와 커버리지 상한 슬라이더가 표시됩니다 &mdash; 아래로 드래그하면 선택한 비율을 초과하는 파일이 숨겨져 커버리지가 가장 낮은 파일만 남습니다(엣지도 함께 숨겨짐).",
        "faq.coverage.li3": "커버리지, 활동량, Git 모드는 모두 상호 배타적입니다 &mdash; 하나를 켜면 나머지 둘은 꺼집니다. 세 모드 모두 서로 다른 신호로 노드를 색칠하기 때문입니다.",
        "faq.coverage.li4": "커버리지 모드를 켜면 code를 제외한 모든 Node types가 자동으로 숨겨집니다 &mdash; 커버리지 보고서가 실제로 알려줄 수 있는 파일은 이것뿐이기 때문입니다. 다른 유형을 숨길 때와 마찬가지로 범례에서 언제든 다시 표시할 수 있습니다.",
        "legend.diffEdgesAdded": "새 엣지",
        "legend.diffEdgesRemoved": "제거된 엣지",
        ...
        "btn.cycles": "순환",
        "btn.cyclesTitle": "순환 임포트 강조 — 서로를 루프로 임포트하는 파일",
        "faq.filters.li12": "<b>순환</b> 버튼(범례에 있으며 임포트 루프가 있을 때만 표시)은 코드 파일 간의 순환 <code>import</code> 체인을 산호색으로 강조합니다. <code>TYPE_CHECKING</code> 아래에서만 이루어지는 임포트는 계산되지 않습니다 &mdash; 바로 그런 루프를 끊기 위해 존재하기 때문입니다.",
...
const FORMATTERS = {
    en: {
        ...
        heatPeriod: days => "last " + days + " day" + (days !== 1 ? "s" : ""),
        heatCount: n => n + " edit" + (n !== 1 ? "s" : "")
    },
    ru: {
        ...
        heatPeriod: days => "последние " + days + " " + pluralRu(days, "день", "дня", "дней"),
        heatCount: n => n + " " + pluralRu(n, "правка", "правки", "правок")
    },
    de: {
        connectionCount: n => n + " " + (n === 1 ? "Verbindung" : "Verbindungen"),
        stats: (nodes, edges) => nodes + " Knoten · "
            + edges + " " + (edges === 1 ? "Kante" : "Kanten"),
        heatPeriod: days => "letzte " + days + " " + (days === 1 ? "Tag" : "Tage"),
        heatCount: n => n + " " + (n === 1 ? "Änderung" : "Änderungen")
    },
    es: {
        connectionCount: n => n + " " + (n === 1 ? "conexión" : "conexiones"),
        stats: (nodes, edges) => nodes + " " + (nodes === 1 ? "nodo" : "nodos")
            + " · " + edges + " " + (edges === 1 ? "arista" : "aristas"),
        heatPeriod: days => "últimos " + days + " " + (days === 1 ? "día" : "días"),
        heatCount: n => n + " " + (n === 1 ? "edición" : "ediciones")
    },
    it: {
        connectionCount: n => n + " " + (n === 1 ? "connessione" : "connessioni"),
        stats: (nodes, edges) => nodes + " " + (nodes === 1 ? "nodo" : "nodi")
            + " · " + edges + " " + (edges === 1 ? "arco" : "archi"),
        heatPeriod: days => "ultimi " + days + " " + (days === 1 ? "giorno" : "giorni"),
        heatCount: n => n + " " + (n === 1 ? "modifica" : "modifiche")
    },
    fr: {
...
function applyI18n(lang) {
    ...
    try {
        if (typeof updateHeatPeriodLabel === "function") updateHeatPeriodLabel();
    } catch (_) {}
}
